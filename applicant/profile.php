            ...
            ?>
                <div class="card">
                  <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                    ...
                    <img alt="Profile Picture" class="img-circle" <?php echo '<img src="../imageStorage/' . $image . '" />'; ?> <h2><?php echo $row['firstname'], " ", $row['lastname']; ?></h2>
              ...
              <div class="card-body">
                ...
                <?php }
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <input name="state" type="text" class="form-control" id="Address" value="<?php echo $row['region']; ?>" required>
                    </div>
                  </div>
                ...
                <div class="tab-pane fade show profile-requirements" id="profile-requirements">
                  ...
                  <table class="table table-sm">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          <td><a href="#" download="<?php echo $select_file_row['resume_file'] ?>"><?php echo $select_file_row['resume_file'] ?></a></td>
